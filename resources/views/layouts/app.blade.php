              ...
              <div class="panel panel-default">
                <div class="panel-body">
                     <ul class="list-group">
                         ...
                         <li class="list-group-item">
                                <a href="/forum?filter=me" style="text-decoration:none;">My Disscussion</a>
                         </li>
                         <li class="list-group-item">
                                <a href="/forum?filter=solved" style="text-decoration:none;">Answered Disscussion</a>
                         </li>
                         <li class="list-group-item">
                                <a href="/forum?filter=unsolved" style="text-decoration:none;">Unanswered Disscussion</a>
                         </li>
                     </ul>
                </div>
                @if(Auth::check())
